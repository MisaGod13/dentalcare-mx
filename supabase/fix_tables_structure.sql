-- =====================================================
-- CORRECCIÓN DE ESTRUCTURA DE TABLAS PARA PACIENTES
-- =====================================================
...
BEGIN
    ...
    IF NOT EXISTS (SELECT FROM pg_indexes WHERE indexname = 'idx_medical_history_patient_id') THEN
        CREATE INDEX idx_medical_history_patient_id ON public.medical_history(patient_id);
        RAISE NOTICE 'Índice idx_medical_history_patient_id creado';
    END IF;
    
    IF NOT EXISTS (SELECT FROM pg_indexes WHERE indexname = 'idx_medical_history_consultation_date') THEN
        CREATE INDEX idx_medical_history_consultation_date ON public.medical_history(consultation_date);
        RAISE NOTICE 'Índice idx_medical_history_consultation_date creado';
    END IF;
END $$;
...
BEGIN
    ...
    -- Crear índices si no existen
    IF NOT EXISTS (SELECT FROM pg_indexes WHERE indexname = 'idx_patient_recommendations_patient_id') THEN
        CREATE INDEX idx_patient_recommendations_patient_id ON public.patient_recommendations(patient_id);
        RAISE NOTICE 'Índice idx_patient_recommendations_patient_id creado';
    END IF;
    
    IF NOT EXISTS (SELECT FROM pg_indexes WHERE indexname = 'idx_patient_recommendations_status') THEN
        CREATE INDEX idx_patient_recommendations_status ON public.patient_recommendations(status);
        RAISE NOTICE 'Índice idx_patient_recommendations_status creado';
    END IF;
END $$;
...
BEGIN
    ...
    -- Crear índices si no existen
    IF NOT EXISTS (SELECT FROM pg_indexes WHERE indexname = 'idx_patient_diagnoses_patient_id') THEN
        CREATE INDEX idx_patient_diagnoses_patient_id ON public.patient_diagnoses(patient_id);
        RAISE NOTICE 'Índice idx_patient_diagnoses_patient_id creado';
    END IF;
    
    IF NOT EXISTS (SELECT FROM pg_indexes WHERE indexname = 'idx_patient_diagnoses_diagnosis_date') THEN
        CREATE INDEX idx_patient_diagnoses_diagnosis_date ON public.patient_diagnoses(diagnosis_date);
        RAISE NOTICE 'Índice idx_patient_diagnoses_diagnosis_date creado';
    END IF;
END $$;
...
BEGIN
    ...
    -- Crear índices si no existen
    IF NOT EXISTS (SELECT FROM pg_indexes WHERE indexname = 'idx_patient_notifications_patient_id') THEN
        CREATE INDEX idx_patient_notifications_patient_id ON public.patient_notifications(patient_id);
        RAISE NOTICE 'Índice idx_patient_notifications_patient_id creado';
    END IF;
    
    IF NOT EXISTS (SELECT FROM pg_indexes WHERE indexname = 'idx_patient_notifications_is_read') THEN
        CREATE INDEX idx_patient_notifications_is_read ON public.patient_notifications(is_read);
        RAISE NOTICE 'Índice idx_patient_notifications_is_read creado';
    END IF;
    
    IF NOT EXISTS (SELECT FROM pg_indexes WHERE indexname = 'idx_patient_notifications_created_at') THEN
        CREATE INDEX idx_patient_notifications_created_at ON public.patient_notifications(created_at);
        RAISE NOTICE 'Índice idx_patient_notifications_created_at creado';
    END IF;
END $$;
...
BEGIN
    ...
    -- Crear índices si no existen
    IF NOT EXISTS (SELECT FROM pg_indexes WHERE indexname = 'idx_appointments_patient_id') THEN
        CREATE INDEX idx_appointments_patient_id ON public.appointments(patient_id);
        RAISE NOTICE 'Índice idx_appointments_patient_id creado';
    END IF;
    
    IF NOT EXISTS (SELECT FROM pg_indexes WHERE indexname = 'idx_appointments_appointment_date') THEN
        CREATE INDEX idx_appointments_appointment_date ON public.appointments(appointment_date);
        RAISE NOTICE 'Índice idx_appointments_appointment_date creado';
    END IF;
    
    IF NOT EXISTS (SELECT FROM pg_indexes WHERE indexname = 'idx_appointments_status') THEN
        CREATE INDEX idx_appointments_status ON public.appointments(status);
        RAISE NOTICE 'Índice idx_appointments_status creado';
    END IF;
END $$;

-- 8. CREAR POLÍTICAS RLS (con DROP IF EXISTS para evitar errores)
...
-- 10. VERIFICAR QUE TODAS LAS TABLAS SE CREARON CORRECTAMENTE
SELECT 

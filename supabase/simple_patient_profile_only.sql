...
CREATE OR REPLACE FUNCTION create_patient_profile_only(
  patient_email TEXT,
  patient_name TEXT,
  patient_id UUID,
  dentist_id UUID
...
GRANT EXECUTE ON FUNCTION create_patient_profile_only(TEXT, TEXT, UUID, UUID) TO authenticated;

-- Comentario de la función
COMMENT ON FUNCTION create_patient_profile_only IS 'Crea solo el perfil de paciente (sin usuario de auth)';
